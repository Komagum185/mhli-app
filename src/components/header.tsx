...
//   // Remember which page the menu was opened on. Navigating changes the
//   // pathname, so the menu closes itself without an effect.
...
//     <header
//       ref={headerRef}
//       className="sticky top-0 z-50 border-b border-line bg-forest-deep backdrop-blur-md"
//     >
//       <div className="wrap flex items-center justify-between gap-4 py-3">
//         <Link
//           to="/"
//           aria-label={`${site.name}, home`}
//           className={`flex min-w-0 items-center gap-3 text-stone-dim ${focusRing}`}
//         >
//           <LogoMark className="h-8 w-8 shrink-0 text-forest" />
//           {/* <span className="font-heading text-sm leading-tight font-semibold sm:text-base">
//             {site.name}
//             <span className="mt-0.5 hidden text-xs font-normal text-ink-soft sm:block">
//               Kitswamba, Uganda
//             </span>
//           </span> */}
//         </Link>
...
//               className={`border-b border-transparent pb-0.5 whitespace-nowrap text-highland transition-colors hover:border-clay hover:text-clay-soft aria-[current=page]:border-clay aria-[current=page]:text-forest ${focusRing}`}
//             >
//               {link.label}
//             </Link>
//           ))}
...
//             className={`inline-flex h-11 w-11 items-center justify-center rounded-sm border border-line text-forest-deep lg:hidden ${focusRing}`}
//           >
//             <svg
//               viewBox="0 0 24 24"
//               className="h-6 w-6"
...
//         id={panelId}
//         hidden={!open}
//         className="absolute inset-x-0 top-full max-h-[80dvh] overflow-y-auto border-b border-line bg-stone shadow-lift lg:hidden"
//       >
...
//                   aria-current={isActive(pathname, link.href) ? "page" : undefined}
//                   className={`flex min-h-12 items-center text-base text-forest-deep aria-[current=page]:font-semibold aria-[current=page]:text-forest ${focusRing}`}
//                 >
//                   {link.label}
//                 </Link>
//               </li>
...
//             to="/contact"
//             onClick={() => setOpenedAt(null)}
//             className="btn btn-primary my-4 w-full sm:hidden"
//           >
//             Support our work
//           </Link>
//         </nav>
    ...
    >
      <div className="wrap flex items-center justify-between gap-4 py-3">
        ...
        >
          ...
          {/* <span className="font-heading text-sm leading-tight font-semibold sm:text-base">
            {site.name}
            <span className="mt-0.5 hidden text-xs font-normal sm:block" style={{ color: ink[300] }}>
              Kitswamba, Uganda
            </span>
          </span> */}
        </Link>
